"""
predict.py - Fixed version with proper model and scaler loading
"""
...
# Load models and scalers directly
...
try:
    ...
    print("✅ Loaded flowering_model.pkl and flowering_scaler.pkl")
except Exception as e:
    print(f"⚠️  Failed to load flowering models: {e}")
...
try:
    ...
    print("✅ Loaded psi_model.pkl and psi_scaler.pkl")
except Exception as e:
    print(f"⚠️  Failed to load PSI models: {e}")
    psi_model = None
    psi_scaler = None
...
try:
    ...
    print("✅ Loaded risk_model.pkl and risk_scaler.pkl")
except Exception as e:
...
def predict(features: PollinationFeatures) -> PredictionResult:
    ...
    # Check if we have trained models AND scalers
    if (flowering_model is not None and flowering_scaler is not None and 
        psi_model is not None and psi_scaler is not None and
        risk_model is not None and risk_scaler is not None):
